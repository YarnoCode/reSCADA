        ...
        Prom::UnMdNoDef )
{
    ...
    rangeTop = new OutETag( this, Prom::TpOut, Prom::PreSet, "макс. открытие",  TagsMap->at(regValve::rangeTopDBN), false, false, false, true);
    rangeBottom = new OutETag( this, Prom::TpOut, Prom::PreSet, "макс. закрытие",  TagsMap->at(regValve::rangeBottomDBN), false, false, false, true);
...
void RegValveDO::_customConnectToGUI(QObject *guiItem, QObject *)
{
    ...
    //Для pos OutETag
    //connect( guiItem, SIGNAL(s_valvePosChanged(QVariant)), pos , SLOT( setValue(QVariant) ), Qt::QueuedConnection );
